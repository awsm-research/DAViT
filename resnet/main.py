...
from transformers import get_constant_schedule, AutoImageProcessor, AutoModel, AutoConfig, get_linear_schedule_with_warmup, ViTModel
...
class TextDataset(Dataset):
    def __init__(self, feature_processor, args, file_type="train"):
        ...
        if file_type == "train":
            ...
            transforms.RandomResizedCrop(224),  # RandomResizedCrop
...
def main():
    ...
    if args.model_name_or_path == "resnet50":
        resnet = models.resnet50(pretrained=True)
    elif args.model_name_or_path == "resnet152":
        resnet = models.resnet152(pretrained=True)
    elif args.model_name_or_path == "resnext101":
        resnet = models.resnext101_32x8d(pretrained=True)
    elif args.model_name_or_path == "wide_resnet101":
        resnet = models.wide_resnet101_2(pretrained=True)
    
    model = Model(resnet, feature_processor, args)
