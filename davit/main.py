...
def main():
    ...
    filtered_state_dict = {}
    # Iterate over the loaded state_dict
    for layer_name, weights in state_dict.items():
        # Check if the layer exists in the model's state_dict and the shapes match
        if layer_name in model_state_dict and model_state_dict[layer_name].shape == weights.shape:
            filtered_state_dict[layer_name] = weights  # Only add matching parameters
